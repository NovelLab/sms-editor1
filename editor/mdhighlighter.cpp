...
MdHighlighter::MdHighlighter(int font_size, QTextDocument *parent)
    : QSyntaxHighlighter{parent},
      base_font_size_{font_size}
{
    InitRules_();
}
